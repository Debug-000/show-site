...
func init() {
	...
	// templateFuncMap["EntGQLType"] = custom_model.EntGQLType
...
func main() {
	// paginationTemplate, err := gen.NewTemplate("pagination.go.tmpl").Funcs(templateFuncMap).ParseFiles("./templates/entgql/pagination.go.tmpl")

	// if err != nil {
	// 	log.Fatalf("cannot parse pagination template: %w", err)
	// }
	...
	opts := []entc.Option{
		entc.Extensions(ex),
		// entc.TemplateFiles("./templates/entgql/additional_fields.go.tmpl"),
...
// func CreateExtendedTypes() gen.Hook {
// 	return func(next gen.Generator) gen.Generator {
// 		return gen.GenerateFunc(func(g *gen.Graph) error {
// 			t := TemplateData{
// 				Graph: g,
...
// 			tmpl, err := templates.LoadTemplate("extended_types.graphql.tmpl", "graphql/extended_types.graphql.tmpl", templateFuncMap)
// 			if err != nil {
// 				return fmt.Errorf(errFormat, fmt.Errorf("error parsing template file: %w", err)
// 			}

// 			f, err := os.Create("./graphql/extended_types.graphql")
// 			if err != nil {
// 				return fmt.Errorf(errFormat, fmt.Errorf("error creating file: %w", err)
// 			}
...
// func CreateExtendedTypeResolvers() gen.Hook {
// 	return func(next gen.Generator) gen.Generator {
// 		return gen.GenerateFunc(func(g *gen.Graph) error {
// 			t := TemplateData{
// 				Graph: g,
...
// 			tmpl, err := templates.LoadTemplate("extended_types.resolvers.go.tmpl", "resolver/extended_types.resolvers.go.tmpl", templateFuncMap)
// 			if err != nil {
// 				return fmt.Errorf(errFormat, fmt.Errorf("error parsing template file: %w", err)
// 			}

// 			f, err := os.Create("./domain/resolvers/extended_types.resolvers.go")
// 			if err != nil {
// 				return fmt.Errorf(errFormat, fmt.Errorf("error creating file: %w", err)
// 			}
