...
export const handleCodeGenerationCompleted = () => {
   
    appStatusVar(AppStatusEvent.CODE_GENERATION_COMPLETED);
    entitiesInCodeGenerationVar([])

    addNotification({
        message: "Code generation is complete",
        type: 'success'
    });
};