...
func (Entity) DeleteEntity(ctx context.Context, where entity.EntityWhereUniqueInput) (*entity.Entity, error) {
	// entityToDelete, ok := cache.Entity.GetByUniqueInput(where)
	// if !ok {
